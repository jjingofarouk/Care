...
import {
  ...
  WrenchIcon, XCircleIcon, StethoscopeIcon, SyringeIcon, PillIcon, ReceptionistIcon,
  ScanIcon, ScalpelIcon, DollarSignIcon, Building2Icon, HardHatIcon, LockIcon,
} from 'lucide-react';
...
const roleBasedNavItems = {
  ...
  DOCTOR: [
    ...
    { name: 'Clinical', path: '/clinical', icon: StethoscopeIcon, category: 'clinical' },
    { name: 'Operation Theatre', path: '/operation-theatre', icon: ScalpelIcon, category: 'clinical' },
  ],
  NURSE: [
    { name: 'Dashboard', path: '/', icon: HomeIcon, category: 'main' },
    { name: 'Patients', path: '/patient', icon: UserIcon, category: 'patient-care' },
    ...
    { name: 'Vaccination', path: '/vaccination', icon: SyringeIcon, category: 'nursing' },
  ],
  LAB_TECHNICIAN: [
    { name: 'Dashboard', path: '/', icon: HomeIcon, category: 'main' },
  ...
  PHARMACIST: [
    { name: 'Dashboard', path: '/', icon: HomeIcon, category: 'main' },
    { name: 'Pharmacy', path: '/pharmacy', icon: PillIcon, category: 'pharmacy' },
  ...
  RECEPTIONIST: [
    ...
    { name: 'Helpdesk', path: '/helpdesk', icon: ReceptionistIcon, category: 'support' },
  ],
  RADIOLOGIST: [
    { name: 'Dashboard', path: '/', icon: HomeIcon, category: 'main' },
    { name: 'Radiology', path: '/radiology', icon: ScanIcon, category: 'lab' },
  ],
  SURGEON: [
    { name: 'Dashboard', path: '/', icon: HomeIcon, category: 'main' },
    { name: 'Patients', path: '/patient', icon: UserIcon, category: 'patient-care' },
  ...
  ADMIN: [
    { name: 'Dashboard', path: '/', icon: HomeIcon, category: 'main' },
    { name: 'Patients', path: '/patient', icon: UserIcon, category: 'patient-care' },
    { name: 'Doctors', path: '/doctor', icon: IdentificationIcon, category: 'patient-care' },
    { name: 'Appointments', path: '/appointment', icon: CalendarIcon, category: 'patient-care' },
    ...
    { name: 'Radiology', path: '/radiology', icon: ScanIcon, category: 'clinical' },
    { name: 'Operation Theatre', path: '/operation-theatre', icon: ScalpelIcon, category: 'clinical' },
    ...
    { name: 'Incentive', path: '/incentive', icon: DollarSignIcon, category: 'finance' },
  ...
  HOSPITAL_MANAGER: [
    ...
    { name: 'Reports', path: '/reports', icon: TableCellsIcon, category: 'reports' },
    { name: 'Dynamic Report', path: '/dynamic-report', icon: TableCellsIcon, category: 'reports' },
    { name: 'Departments', path: '/departments', icon: Building2Icon, category: 'admin' },
    { name: 'Settings', path: '/settings', icon: CogIcon, category: 'admin' },
  ],
  IT_SUPPORT: [
    { name: 'Dashboard', path: '/', icon: HomeIcon, category: 'main' },
  ...
  CLEANING_STAFF: [
    { name: 'Dashboard', path: '/', icon: HomeIcon, category: 'main' },
    { name: 'CSSD', path: '/cssd', icon: ShieldCheckIcon, category: 'operations' },
  ],
  SECURITY: [
    { name: 'Dashboard', path: '/', icon: HomeIcon, category: 'main' },
    { name: 'Security', path: '/security', icon: LockIcon, category: 'operations' },
  ],
  GUEST: [
