...
export default function ClinicalTaskNew() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-4">New Clinical Task</h1>
      <form onSubmit={handleSubmit} className="bg-hospital-white p-6 rounded-lg shadow">
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-hospital-gray-700">Assigned To ID</label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-hospital-gray-700">Assigned To Type</label>
          <input
            type="text"
            value={formData.assignedToType}
            onChange={(e) => setFormData({ ...formData, assignedToType: e.target.value })}
            className="mt-1 block w-full rounded-md border-hospital-gray-300 shadow-sm focus:border-hospital-accent focus:ring focus:ring-hospital-accent focus:ring-opacity-50"
          />
        </div>
        <div className="mb-4">
